...
//             </div>
//             {D.map((item) => <div key={item.id} style={{marginLeft: "25%"}}><h1>{item.name}</h1><img src={item.image.url} style={{borderRadius: "10px", width: "500px", height: "500px"}}/><h1 style={{color: "blue"}}>{item.temperament}</h1><h1 style={{color: "red"}}>life span: {item.life_span}</h1></div>)}
//             </>)
// }
